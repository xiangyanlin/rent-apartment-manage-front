export default {
  ...
  'form.oldPassword.placeholder': '旧密码',
  ...
  'form.realName.placeholder': '真实姓名',
  'form.idCard.placeholder': '身份证号',
  'form.title.label': '标题',
  ...
  'app.password.update': '完成修改',
  'app.password.identify': '完成认证',
  ...
  'app.settings.menuMap.certification': '实名认证',
  ...
  'app.settings.basic.geographic': '所在省市区',
  ...
  'app.settings.basic.profession': '职业',
  'app.settings.basic.education': '学历',
