...
class Dict extends PureComponent {
  ...
  columns = [
...

    {
      ...
      render: (text, record) => (
        <Fragment>
          <EditDict record={record} reloadDict={this.reloadDict.bind(this)} />
  ...
  reloadDict(id) {
    if (typeof id == 'undefined') id = this.state.selectNodeId;
    const { dispatch } = this.props;
    dispatch({
      type: 'dict/dictList',
        ...
        <Card>
          <Row gutter={16}>
            <Col span={8}>
                ...
                <Row>
                  ...
                  <Col span={17} className={dictStyle.right}>
                    ...
                    <EditDictType
                      ...
                      reloadDictType={this.reloadDictType.bind(this)}
                    />
                    <Button
                      type="link"
                      icon="delete"
                      onClick={() => {
                        this.delDictType(checkNodeIds);
                      }}
                    >
                      删除
                    </Button>
              ...
              <Tree checkable defaultExpandAll onSelect={this.onSelect} onCheck={this.onCheck}>
            ...
            <Col span={16}>
              <div className={dictStyle.line}>
                <Row>
                  ...
                  <Col span={17} className={dictStyle.right}>
                    <AddDict checkNodeIds={checkNodeIds} reloadDict={this.reloadDict.bind(this)} />
                  </Col>
                </Row>
              </div>
